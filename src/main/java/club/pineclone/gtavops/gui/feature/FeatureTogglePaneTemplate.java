...
public abstract class FeatureTogglePaneTemplate {
    ...
    public FeatureTogglePaneTemplate(final FeatureContext context, final VSettingStage setting) {
    ...
    private class ClickEventHandler implements EventHandler<MouseEvent> {
        ...
        public void handle(MouseEvent e) {
            if (e.getButton() == MouseButton.PRIMARY) {
                ...
                VSettingStage settingStage = FeatureTogglePaneTemplate.this.setting;
