...
public class ForkedLoadingStage extends VStage {

    @Getter private final ForkedLoadingPane loadingPane;

    public ForkedLoadingStage(String title) {
        super(new VStageInitParams()
                .setIconifyButton(false)
                .setMaximizeAndResetButton(false)
                .setResizable(false));

        loadingPane = new ForkedLoadingPane(title);
