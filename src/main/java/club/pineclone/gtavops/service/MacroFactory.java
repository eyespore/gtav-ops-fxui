...
import club.pineclone.gtavops.core.macro.action.impl.*;
import club.pineclone.gtavops.domain.dto.macro.*;
import club.pineclone.gtavops.core.macro.Macro;
import club.pineclone.gtavops.core.macro.SimpleMacro;
import club.pineclone.gtavops.core.macro.action.Action;
import club.pineclone.gtavops.core.macro.action.impl.betterlbutton.HoldLButtonAction;
import club.pineclone.gtavops.core.macro.action.impl.betterlbutton.RapidlyClickLButtonAction;
import club.pineclone.gtavops.core.macro.action.impl.betterlbutton.RemapLButtonAction;
import club.pineclone.gtavops.core.macro.action.impl.bettermmenu.AutoSnakeAction;
import club.pineclone.gtavops.core.macro.action.impl.bettermmenu.StartEngineAction;
import club.pineclone.gtavops.core.macro.action.impl.betterpmenu.JoinABookmarkedJobAction;
import club.pineclone.gtavops.core.macro.action.impl.betterpmenu.JoinANewSessionAction;
import club.pineclone.gtavops.core.macro.action.impl.swapglitch.SwapGlitchAction;
import club.pineclone.gtavops.core.macro.action.impl.swapglitch.SwapMeleeAction;
import club.pineclone.gtavops.core.macro.action.impl.swapglitch.SwapRangedAction;
import club.pineclone.gtavops.core.macro.trigger.Trigger;
import club.pineclone.gtavops.core.macro.trigger.TriggerFactory;
import club.pineclone.gtavops.core.macro.trigger.TriggerIdentity;
