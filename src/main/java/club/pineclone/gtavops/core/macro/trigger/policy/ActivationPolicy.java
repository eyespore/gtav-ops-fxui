package club.pineclone.gtavops.core.macro.trigger.policy;

/* 触发模式，例如按住、切换 */

import club.pineclone.gtavops.core.macro.MacroLifecycleAware;
import club.pineclone.gtavops.core.macro.trigger.TriggerStatus;
