...
import club.pineclone.gtavops.config.ClientConfigLoader;
...
import club.pineclone.gtavops.scene.ConfigScene;
import club.pineclone.gtavops.scene.IntroScene;
import club.pineclone.gtavops.scene.MacroToggleScene;
import club.pineclone.gtavops.scene.SceneTemplate;
import club.pineclone.gtavops.theme.DimTheme;
...
//        MDC.put("module", "[Client]");  /* 初始化日志 */
        try {
            ...
            /* 使用自实现的 jnativehook 管理器，而不是 VFX jnativehook 管理，避免 native 文件引入异常的问题 */
