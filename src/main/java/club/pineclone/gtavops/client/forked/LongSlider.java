...
public class LongSlider extends Pane {
    ...
    public LongSlider(SliderDirection sliderDirection) {
        ...
        valueProperty.bind(Bindings.createDoubleBinding(() -> {
            ...
            return minValue + range * percentageProperty().get();
        }, percentageProperty(), updateProperty));
...
//        buttonLabel.setText(String.valueOf((int) Math.floor(valueProperty.get())));
        buttonLabel.textProperty().bind(Bindings.createStringBinding(() ->
                String.valueOf((int) valueProperty.get()), valueProperty));
    ...
    public ThemeLabel getButtonLabel() {
        return buttonLabel;
    }

    public ClickableCircle getButton() {
        return button;
    }
